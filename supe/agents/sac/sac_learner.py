...
from supe.agents.agent import Agent
...
from supe.networks import MLP, Ensemble, StateActionValue, subsample_ensemble
...
class SACLearner(Agent):
    ...
    def update(self, batch: DatasetDict, utd_ratio: int):
        ...
        if "encoder_0" in new_agent.actor.params:
            for key in new_agent.actor.params["encoder_0"]:
                weights = new_agent.actor.params["encoder_0"][key]["kernel"]
                temp_info["cnn_norm/" + str(key)] = jnp.linalg.norm(weights)
